//NOTE: This one is to control edit boxes
...
const handleDragMove = (e, canvasWidth, canvasHeight) => {
  ...
  const top = group.get('.top')[0];
  const left = group.get('.left')[0];
  const right = group.get('.right')[0];
  const bottom = group.get('.bottom')[0];
