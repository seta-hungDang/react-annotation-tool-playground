...
const handleGroupDragMove = (e, canvasWidth, canvasHeight) => {
  console.log('Group drag move', e.target.getClassName());
  ...
  absY =
    absY + rect.height() > canvasHeight ? canvasHeight - rect.height() : absY;
        ...
        if (played >= incidents[i].time) {
          ...
          layerItems.push(
            <Group
              ...
              onDragMove={e =>
                handleGroupDragMove(e, canvasWidth, canvasHeight)
              }
            >
              {labelText}
              {rect}
