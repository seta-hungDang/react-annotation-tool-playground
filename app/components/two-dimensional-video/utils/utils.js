const getAnnotationIdByLabel = (label, annotations, entities) =>
...
const getSortedAnnotationsByLabel = (annotations, entities) => {
  ...
  let i = 1;
  while (
    sortedAnnotations.length < annotations.length &&
...
export { getSortedAnnotationsByLabel, getLastAnnotationLabel, getUniqueKey };
